...
const dockerEssentialsSubTopic: SubTopic = {
  id: 'essentials',
  title: 'Docker Essentials',
  description:
    'From “what is Docker?” through architecture, everyday CLI commands, Dockerfiles, and Compose.',
  lessonTracks: [
    {
      id: 'foundations',
      title: 'Foundations',
...
export const dockerTopic: Topic = {
  ...
  accent: 'docker',
  catalog: [{ type: 'subTopic', subTopicId: 'essentials' }],
  subTopics: [dockerEssentialsSubTopic],
}
