...
const coreConceptLessons = [
  ...
  },
  {
    id: 'memory',
    title: 'Memory',
    description: 'Why the model is stateless, where to store conversation memory, how to implement load-inject-save, then LangChain buffer, window, and summary types.',
    readTime: '14 min',
    component: Memory,
  },
  {
