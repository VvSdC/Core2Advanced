  ...
  return (
    ...
    >
      ...
      >
        ...
        {lessons[0] ? (
          <p className="mt-4 text-xs text-slate-500">Starts with: {lessons[0].title}</p>
        ) : null}
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 md:px-6 md:py-16">
      ...
      <motion.header
        ...
        className="mt-6"
      >
        <p className="text-xs font-semibold uppercase tracking-wider text-python-400">Topic</p>
